...
public class pap_eeeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        returning=inflater.inflate(R.layout.activity_pap_eee_fragment, container, false);
        ...
        y_15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2015");
                startActivity(i);
            }
        });
        y_14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2014");
                startActivity(i);
            }
        });
        y_13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2013");
                startActivity(i);
            }
        });
        y_12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2012");
                startActivity(i);
            }
        });
        y_11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2011");
                startActivity(i);
            }
        });
        y_10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2010");
                startActivity(i);
            }
        });
        y_09.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2009");
                startActivity(i);
            }
        });
        y_08.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i.putExtra("File_Name","EEE_Q_2008");
                startActivity(i);
            }
        });
        return returning;
